...
subgraph ResBlocks
    res1[ResBlock<br/>ch: 32, ksize: 3, stride: 1, padding: 1<br/>BatchNormalization<br/>ReakyReLU]
    res2[ResBlock<br/>ch: 64, ksize: 3, stride: 1, padding: 1<br/>BatchNormalization<br/>ReakyReLU]
    res3[ResBlock<br/>ch: 128, ksize: 3, stride: 1, padding: 1<br/>BatchNormalization<br/>ReakyReLU]
